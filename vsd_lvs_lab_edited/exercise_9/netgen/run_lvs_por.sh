...
#--------------------------------------------------------------------------------
netgen -batch lvs "../mag/example_por.spice example_por" \
"../xschem/example_por_tb.spice example_por" \
/usr/share/pdk/sky130A/libs.tech/netgen/sky130A_setup.tcl exercise_9_comp.out -json | tee lvs.log
echo ""
